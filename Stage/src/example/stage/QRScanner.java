...
public class QRScanner extends Activity implements OnQRCodeReadListener 
{
	...
	//	myTextView = (TextView) findViewById(R.id.scanText);
	...
	{
		Intent intent= new Intent().setClass(getApplicationContext(), BookTicket.class);
